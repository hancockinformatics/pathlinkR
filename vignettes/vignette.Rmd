...
## gene-pair signature repository (more in the Supplemental section), but we can 
## simply use the one that comes with `sigora`.
...
analysis using the 
[Hallmark gene sets](https://www.gsea-msigdb.org/gsea/msigdb/human/collections.jsp) 
from the Molecular Signatures Database (MSigDb). These are 50 gene sets that
